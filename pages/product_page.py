...
class ProductPage(BasePage):
    ...
    def should_not_be_success_message(self):
        assert self.is_not_element_present(
            *ProductPageLocators.BASKET_CONFIRM), "Сообщение об успехе представлено, но не должно быть"
        print("OK")

    def should_disappear(self):
        assert self.is_disappeared(
            *ProductPageLocators.BASKET_CONFIRM), "Сообщение об успешном завершении должно исчезнуть, но все равно отображается"
        print("OK")